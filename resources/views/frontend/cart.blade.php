		...
		<div class="container">
			<div class="cart-table">
				<table>
                    ...
                    @empty
                        <tr>
                        <td class="text-center" colspan="4">No product to show</td>
                        </tr>
                    @endforelse
					...
					<div class="offset-lg-2 col-lg-6">
						<div class="cart-total-details">
							...
							<ul class="cart-total-card">
								<li>Subtotal<span>
								@php
								$subtotal = (App\Product::find($cart_item->product_id)->product_price)*($cart_item->product_quantity);
								
								echo $subtotal;
								@endphp
								</span></li>
								<li>Shipping<span>Free</span></li>
								<li class="total">Total<span>{{(App\Product::find($cart_item->product_id)->product_price)*($cart_item->product_quantity)}}</span></li>
							</ul>
